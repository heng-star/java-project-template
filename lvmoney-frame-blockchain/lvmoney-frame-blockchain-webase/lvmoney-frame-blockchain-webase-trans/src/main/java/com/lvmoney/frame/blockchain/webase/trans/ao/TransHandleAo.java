 ...
 * @version:v1.0 2021/6/19 19:47
 */
@Data
@AllArgsConstructor
@NoArgsConstructor
public class TransHandleAo implements Serializable {
    private static final long serialVersionUID = -7569427694959193508L;
    /**
